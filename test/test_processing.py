...
def test_state():
    ...
    assert filter_by_state(users_list, "Executed") == [
        {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
        {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
    ]
...
def test_request():
    assert filter_by_request(transactions, "перевод организации") == [
        {
            "id": 939719570,
            "state": "EXECUTED",
            "date": "2018-06-30T02:08:58.425572",
    ...
    assert filter_by_request(transactions, "пиривод") == []


def test_count_categs():
    assert count_transaction_categories(transactions) == {
